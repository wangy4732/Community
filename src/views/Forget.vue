              ...
              <form method="post">
                ...
                <div class="layui-form-item">
                  <validation-provider name="captcha" rules="required|length:4" v-slot="{errors}">
                    ...
                    <div class="">
                      <span class="svg" style="color: #c00;" @click="getCaptcha" v-html="svg">captcha</span>
                    </div>
                    <div class="layui-form-mid layui-word-aux">{{errors[0]}}</div>
                  </validation-provider>
                </div>
                <div class="layui-form-item">
                  <button type="button" class="layui-btn" alert="1" lay-filter="*" lay-submit @click="submit()">提交</button>
                </div>
              </form>
            </div>
          </div>
